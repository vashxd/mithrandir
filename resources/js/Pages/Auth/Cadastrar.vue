    ...
    <div class="min-h-screen bg-fundo px-5 py-10">
        <div class="mx-auto w-full max-w-sm">
            <div class="mb-6 text-center">
                ...
                <h1 class="mt-3 text-2xl font-bold text-tinta">Criar conta</h1>
            </div>
            ...
            <form class="cartao space-y-4 p-6" @submit.prevent="enviar">
                <div>
                    ...
                    <p v-if="formulario.errors.name" class="mt-1 text-sm text-perigo">{{ formulario.errors.name }}</p>
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div class="col-span-2">
                        ...
                        <p v-if="formulario.errors.oab" class="mt-1 text-sm text-perigo">{{ formulario.errors.oab }}</p>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <p v-if="formulario.errors.password" class="mt-1 text-sm text-perigo">{{ formulario.errors.password }}</p>
                </div>
                ...
                <div class="rounded-xl bg-superficie-2 p-4 ring-1 ring-borda">
                    <label class="flex items-start gap-2.5">
                        <input v-model="formulario.aceite_termo" type="checkbox" class="mt-0.5 h-5 w-5 shrink-0 rounded border-borda-forte">
                        <span class="text-sm leading-relaxed text-tinta-2">
                    ...
                    <p v-if="formulario.errors.aceite_termo" class="mt-2 text-sm text-perigo">
            ...
            <p class="mt-6 text-center text-sm text-tinta-2">
                Já tem conta?
                <Link href="/entrar" class="font-semibold text-acento">Entrar</Link>
            </p>
        </div>
    </div>
</template>
