...
<template>
    ...
    <div class="min-h-screen bg-fundo px-5 py-8">
        <div class="mx-auto w-full max-w-lg">
            <h1 class="text-2xl font-bold text-tinta">Termo de uso</h1>
            <p class="mt-1 text-sm text-tinta-3">Versão {{ versao }}</p>

            <div class="cartao mt-5 space-y-5 p-6 text-sm leading-relaxed text-tinta-2">
                <!-- A cláusula que mais importa vem primeiro, não escondida no meio. -->
                <section class="rounded-xl bg-atencao-fundo p-4 ring-1 ring-atencao-borda">
                    <h2 class="font-bold text-atencao-tinta">1. O app não é fonte única de prazo</h2>
                    <p class="mt-2 text-atencao-tinta">
                    ...
                    <p class="mt-2 font-semibold text-atencao-tinta">
                ...
                <section>
                    <h2 class="font-bold text-tinta">2. O que o app faz</h2>
                    <p class="mt-2">
                ...
                <section>
                    <h2 class="font-bold text-tinta">3. Falhas de captura</h2>
                    <p class="mt-2">
                ...
                <section>
                    <h2 class="font-bold text-tinta">4. Dados e sigilo (LGPD)</h2>
                    <p class="mt-2">
                ...
                <section>
                    <h2 class="font-bold text-tinta">5. Limitação de responsabilidade</h2>
                    <p class="mt-2">
            ...
            <form class="mt-5" @submit.prevent="enviar">
                <label class="flex items-start gap-2.5 rounded-2xl bg-superficie p-4 ring-1 ring-borda">
                    <input v-model="formulario.aceite" type="checkbox" class="mt-0.5 h-5 w-5 shrink-0 rounded border-borda-forte">
                    <span class="text-sm leading-relaxed text-tinta">
                ...
                <p v-if="formulario.errors.aceite" class="mt-2 text-sm text-perigo">{{ formulario.errors.aceite }}</p>
